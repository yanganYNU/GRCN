# -*- coding: utf-8 -*-
"""
Created on Thu Apr 25 15:12:27 2022
...
parser.add_argument("--data_name", type=str, default=8,
                    help="the number of data documents [4/8]", required=False)
parser.add_argument('--num_point', type=int, default=307,
                    help='road Point Number [307/170] ', required=False)
...
params_dir = 'result/exp/GRCN'
prediction_path = 'result/prediction/GRCN_0%s' % f
wdecay = 0.000
